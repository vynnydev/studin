...
<h1 align="center">
  <img alt="Layout" src="./github/main-image/logo/studin.png">
</h1>
<br/>
<h1 align="center">
  <img alt="Layout" src="./github/main-image/gif/studin-video.gif">
</h1>

<h1 align="center">Repository with Frontend, Backend and Mobile of the Studin project.</h1>
...
<h1>Backend</h1>
<h3 align="center">
  Express Application for Studin project
</h3>
...
<p align="center">Studin - The efficient search for better studies.</p>

This api is manage Studin app, developed with Typescript, NodeJs, Express, TypeORM, Postgres e JWT.
...
```bash
$ git clone https://github.com/vynnydev/stufin.git && cd studin
...
```bash
# Clone your fork
$ git clone your-fork-url && cd studin
...
<h1>Frontend</h1>
<h3 align="center">
  ReactJS Application for Studin project
</h3>
...
<p align="center">
  <img alt="Layout" src="./github/main-image/signin/studin-signin.png">
</p>
<p align="center">
  <img alt="Layout" src="./github/main-image/signup/studin-signup.png">
</p>
<p align="center">
  <img alt="Layout" src="./github/main-image/reset-password/studin-reset-password.png">
</p>
...
```bash
$ git clone https://github.com/vynnydev/studin.git && cd studin
```
...
<h3 align="center">
  React Native Application for Studin project
</h3>
...
<p align="center">
  <img alt="Layout" src="github/main-image/splashscreen/studin-splashscreen.png">
</p>
...
- Have this application's [API](https://github.com/vynnydev/studin_mobile) running

**Clone the project and access the folder**

```bash
$ git clone https://github.com/vynnydev/studin.git && cd studin_mob
OR 
$ git clone https://github.com/vynnydev/studin_mobile.git
...
$ gh repo fork vynnydev/studin_mobile
```
...
# Clone your fork
# 
$ git clone your-fork-url && cd studin_mobile
